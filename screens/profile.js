            ...
            <LinearGradient colors={["#6AF1C5", "#3D7BF7"]} start={{ x: 0.9, y: 0.0 }} style={styles.gradient}>
                <View>
                    <View style={styles.header}>
                        <Ionicons name="ios-arrow-back" size={25} color="black" style={styles.backIcon} />
                    </View >

                    <View style={styles.profileBox}>
                        <View style={styles.profilePic}>
                            <Avatar size={120} rounded source={{ uri: 'https://s3.amazonaws.com/uifaces/faces/twitter/ladylexy/128.jpg', }} style={styles.avatarStyle} />
                        </View>
                        <View style={styles.editBox}>
                            <Feather name="edit-2" size={24} color="white" />
                        </View>
                        <View style={styles.viewText}><Text style={styles.name}>احمد علي</Text></View>
                        ...
                        <View style={styles.describtion}>
                            <View style={styles.describtionDetails} >
                                ...
                                <View style={styles.wachEvent}>
                                    <Text style={styles.textWachEvent}> حدث قمت بالمشاركة بها</Text>
                                    <View>
                                        <Text style={styles.numberText}>
                                            10
                                     </Text>
